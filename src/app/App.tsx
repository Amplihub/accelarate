    ...
    <div className="min-h-screen bg-background font-sans">
      ...
      <section className="relative overflow-hidden pt-[116px] sm:pt-[140px] pb-[32px] sm:pb-[48px] text-center">
        ...
        <div className="flex justify-center mb-6 sm:mb-8" ref={heroCtaRef}>
          <a
            href="#contact"
            className="font-sans font-semibold tracking-[0.025em] cursor-pointer transition-all duration-200 inline-flex items-center justify-between no-underline w-[168px] sm:w-[220px] text-[13px] sm:text-[15px] p-2 sm:p-[10px]"
            style={{
              backgroundColor: "#1A56DB",
              color: "#ffffff",
              borderRadius: "999px",
          ...
          >
            {/* left ghost spacer = same width as arrow circle to optically center the text */}
            <span className="w-[26px] h-[26px] sm:w-[34px] sm:h-[34px] shrink-0" aria-hidden="true" />
            <span className="flex-1 text-center">Book a Call</span>
            <span
              className="inline-flex items-center justify-center rounded-full shrink-0 w-[26px] h-[26px] sm:w-[34px] sm:h-[34px]"
      ...
      {/* Opening breaker only, per request — FAQ and Section 7's Zone A are
          both white. No closing/flip variant added here. */}
      <SectionBreak topColor="#ffffff" bottomColor="#ffffff" />
